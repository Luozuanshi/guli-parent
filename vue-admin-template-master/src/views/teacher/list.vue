 ...
 <!--查询表单-->
    ...
    <el-table
      ...
      <el-table-column label="操作" width="200" align="center">
       ...
       <!-- 分页 -->
       <!-- @current-change=这里不能这么写getTeacherList(参数) -->
    <el-pagination
      :current-page="pageNo"
      :page-size="limit"
      :total="total"
...
<script>
import teacher from "@/api/teacher"; //import要放在script里面
export default {
  data() {
    return {
      pageNo: 1,
  ...
  methods: {
    // 获取讲师列表
    getTeacherList(pageNo = 1) {
      this.pageNo = pageNo;
      teacher.pageList(this.pageNo, this.limit, this.teacherQuery).then(res => {
        console.log(res);
